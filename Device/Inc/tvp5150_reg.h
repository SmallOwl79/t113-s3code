...
#ifndef TVP5150_REG_H_
#define TVP5150_REG_H_
...
#define TVP5150_MAX_NUM_REG 			3


extern const char *TVP5150_NAME_REG[TVP5150_MAX_NUM_REG];
extern const char *TVP5150_NAME_REG_SLAVE[TVP5150_MAX_NUM_REG];
...
//#define	TVP_WRITE_ADDRESS (0xB8>>1) //I2CSEL = 1
//#define	TVP_READ_ADDRESS (0xB8>>1)  //I2CSEL = 1

#define		TVP_I2C_ADDRESS_HI 				(0xBA>>1)
#define		TVP_I2C_ADDRESS_LO 				(0xB8>>1)

//#define		TVP_I2C_ADDRESS_HI 				(0xBA)
//#define		TVP_I2C_ADDRESS_LO 				(0xB8)
...
#define TVP_INT_PRIORITY							4

typedef struct tvp5150_struct{

	struct gpio_t_ 			reset_pin;
...
//	uint16_t				int_pin;
	struct gpio_t_ 			int_pin;

//	IRQn_Type				irq_type;
	osEventFlagsId_t 		cmd_evt_id;
//	osThreadId				cntrl_thread;
	uint32_t				cntrl_int_event;
	uint8_t					i2c_addr;
	uint16_t				addr;
	uint8_t					reg;
}tvp5150_struct;
